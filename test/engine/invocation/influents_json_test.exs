defmodule Engine.Invocation.InfluentsJsonTest do
  @moduledoc false
  ...
  test "null votes show as null" do
    scoring_data = base_scoring_data()
      ...
      |> Map.put(:options, [
        %{id: 1, option_category_id: 1, slug: "option1"},
        %{id: 2, option_category_id: 1, slug: "aaa"}, # should show first always
      ])
      |> Map.put(:participants, [
        %{id: 1, weighting: Decimal.from_float(1.00)},
        %{id: 2, weighting: Decimal.from_float(1.00)},
  ...
  test "triangle votes score correctly without support" do
    ...
    result = scoring_data |> InfluentsJson.build
    expected = [[-1.0, -0.33333333333333326, 0.3333333333333335, 1.0, 0.3333333333333335, -0.33333333333333326, -1.0]]
  ...
  test "triangle votes score correctly when triangle > options" do
    scoring_data = base_scoring_data()
      |> Map.put(:scenario_config,
        %{support_only: true, bins: 5}
      )
