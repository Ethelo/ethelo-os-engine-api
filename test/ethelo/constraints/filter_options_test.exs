defmodule EtheloApi.Constraints.FilterOptionsTest do
  @moduledoc """
  ...
  describe "matches multiple filters" do
    test "returns expected options" do
      ...
      result = FilterOptions.option_ids_matching_filters([all_options_filter, detail_filter])
    ...
    test "returns empty map with no filters" do
      result = FilterOptions.option_ids_matching_filters([])
  ...
  describe "with detail filter" do
    test "matches enabled and disabled by default" do
      match_value = "foo"
