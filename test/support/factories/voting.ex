defmodule EtheloApi.Voting.Factory do
  ...
  def create_option_category_bin_vote(%Decision{} = decision, overrides \\ %{}) do
    ...
    values
    |> Map.take(Map.keys(deps))
    |> Map.put(:option_category_bin_vote, option_category_bin_vote)
  end
  ...
  def option_category_range_vote_deps(%Decision{} = decision) do
    ...
    low_option =
      Structure.create_option_without_deps(decision, %{option_category: option_category})
  ...
  def create_option_category_range_vote(%Decision{} = decision, overrides \\ %{}) do
    ...
    values
    |> Map.take(Map.keys(deps))
    |> Map.put(:option_category_range_vote, option_category_range_vote)
  end
