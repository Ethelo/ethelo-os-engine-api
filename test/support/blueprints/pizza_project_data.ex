defmodule TestSupport.PizzaProjectData do
  ...
  def scoring_data() do
    %EtheloApi.Invocation.ScoringData{
      decision_id: 0,
      auto_constraints: [
        %{
          calculation_id: nil,
      ...
      decision: %{
        ...
        id: 1,
        keywords: [],
        influent_hash: "576460752303418590",
        info: "",
        internal: false,
        language: "en",
        max_users: 25,
        preview_decision_hash: "3F17976A8DAD1C72E0BC13F227148EB4",
        published_decision_hash: "576460752303418654",
        weighting_hash: "576460752303418558"
      },
      quadratic_totals: %{
        by_oc: [],
        global: %{}
      ...
      scenario_config: %{
        ...
        enabled: true,
        engine_timeout: 10000,
        id: 1,
        max_scenarios: 10,
        normalize_influents: false,
        normalize_satisfaction: true,
        per_option_satisfaction: false,
        preview_engine_hash: "576460752303410171",
        published_engine_hash: "576460752303410139",
        quadratic: false,
        skip_solver: false,
        slug: "group",
        solve_interval: 3_600_000,
        support_only: false,
      ...
      variables: [
        ...
        %{
          ...
          option_detail_id: nil,
          option_filter_id: 10,
          slug: "count_uncategorized_options"
        },
        %{
          decision_id: 1,
          id: 12,
