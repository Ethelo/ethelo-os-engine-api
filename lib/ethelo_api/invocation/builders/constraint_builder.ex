defmodule EtheloApi.Invocation.ConstraintBuilder do
  @moduledoc """
  Convert Constraints and Calculation into constraint and display segments
  used by the engine
  """
  ...
  @doc """
  Generates the :constraints and :displays sections of the invocation

  :constraints map direectly to constraints
  :displays map directly to calculations
