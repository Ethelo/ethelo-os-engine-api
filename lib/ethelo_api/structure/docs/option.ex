defmodule EtheloApi.Structure.Docs.Option do
  ...
  @decision_id "The Decision the Option belongs to."
  ...
  @enabled """
  A boolean that indicates if the Option should be included in the Ethelo algorythm. Defaults to "true".
  ...
  @option_category_id "The OptionCategory to source the value from. Options must define an OptionCategory. OptionCategories are used to specify the importance of Options. Each group has a specific \"weight\" applied, making the Options more or less important when calculating the best result."
