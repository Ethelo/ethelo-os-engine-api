defmodule EtheloApi.Structure.Docs.Variable do
  ...
  @decision_id "The Decision the Variable belongs to. "
  ...
  @calculations "Calculations using the Variable."

  @calculation_ids "Ids of Calculations using the Variable preform arithmetic on Variables."
  ...
  * `count_all`: #{@method_count_selected}
  ...
  @option_detail_id "The OptionDetail to source the value from. Option Details allow arbitrary data to be added to an Option. Variables must define either an OptionDetail or an OptionFilter. "

  @option_filter_id "The OptionFilter to source the value from. OptionFilters match a subset of Options. Variables must define either an OptionFilter or an OptionFilter."
  ...
  defp option_detail_fields() do
    [
      ...
      %{
        ...
        type: "id",
        required: "unless option_filter_id is configured",
        validation:
          "must be part of the same Decision. Must be blank if option_filter_id is suupplied."
      },
      %{
        ...
        validation:
          "must be part of the same Decision Must be blank if option_detail_id is suupplied."
      }
    ]
  end

  @doc """
  a list of maps describing all Variable schema fields
