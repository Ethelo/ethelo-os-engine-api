defmodule EtheloApi.Voting.Docs.CriteriaWeight do
  ...
  @decision_id "Unique identifier for the Decision the CriteriaWeight belongs to. All CriteriaWeights are associated with a single Decision."
  ...
  @criteria_id "Unique identifier for the Criteria to weight."
  ...
  @doc """
  strings descriweightingg each field as well as the general concept of "criteria_weights"
  """
  def strings() do
    strings = %{
