defmodule EtheloApi.Structure.Docs.Decision do
  ...
  At it's simplest, a Decision is about choosing from a list of Options.
  """
  ...
  defp decision_fields() do
    [
     ...
     %{name: :keywords, info: @keywords, type: "array[:string]", required: false, automatic: false, immutable: false},
     %{name: :language, info: @language, type: :string, validation: "Must be a valid language", immutable: false},
     %{name: :internal, info: @internal, type: :boolean, default: false, automatic: true, immutable: false},
     %{name: :copyable, info: @copyable, type: :boolean, default: false, automatic: true, immutable: false},
     %{name: :max_users, info: @max_users, type: :integer, default: 20, automatic: true, immutable: false},
   ]
  end
