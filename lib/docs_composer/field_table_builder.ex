defmodule DocsComposer.FieldTableBuilder do
  @moduledoc """
  Generator for markdown tables based on doc configuration
  """
  ...
  defp maybe_add_required(content, %{required: required}),
    do: maybe_add(content, required, "Required.")

  defp maybe_add_automatic(content, %{automatic: automatic}),
    do: maybe_add(content, automatic, "Updated Automatically.")

  defp maybe_add_immutable(content, %{immutable: immutable}),
    do: maybe_add(content, immutable, "Immutable.")
